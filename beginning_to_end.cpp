...
// function to print a sequence, given the number of elements and // the actual sequence stored as an array
int main() {
int n, i, j, max, index;
float *A, *R;
int *H;
...
cout << "Longest non­decreasing subsequence problem, end­to­beginning algorithm" << endl; cout << "Enter the number of elements in the sequence" << endl;
